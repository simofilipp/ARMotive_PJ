...
void OnGUIDelegate_Invoke_mA8B9CF3C0FA6CD716557C7E66D18F061E6410464_Multicast(OnGUIDelegate_tB3BF50E2F15C77EEBC4EA0011B8764FF41C29708* __this, const RuntimeMethod* method)
{
	...
	for (il2cpp_array_size_t i = 0; i < length; i++)
	{
		...
		((FunctionPointerType)currentDelegate->___invoke_impl_1)(currentDelegate, method);
	}
}
...
IL_003d:
	{
		...
		Quaternion_tDA59F214EF07D7700B26E40E562F267AF7306974 L_23 = ___qA0;
		...
		Quaternion_tDA59F214EF07D7700B26E40E562F267AF7306974 L_27 = ___qB1;
		...
		float L_35 = ___t2;
		float L_36;
		L_36 = Mathf_LerpAngle_m1ED3F488EFE973020124E59B6B6D439D9ACCFA42_inline(L_32, L_34, L_35, NULL);
		...
		float L_41 = ___t2;
		float L_42;
		L_42 = Mathf_LerpAngle_m1ED3F488EFE973020124E59B6B6D439D9ACCFA42_inline(L_38, L_40, L_41, NULL);
		...
		float L_47 = ___t2;
		float L_48;
		L_48 = Mathf_LerpAngle_m1ED3F488EFE973020124E59B6B6D439D9ACCFA42_inline(L_44, L_46, L_47, NULL);
		Quaternion_tDA59F214EF07D7700B26E40E562F267AF7306974 L_49;
		L_49 = Quaternion_Euler_mD4601D966F1F58F3FCA01B3FC19A12D0AD0396DD_inline(L_36, L_42, L_48, NULL);
		Quaternion_tDA59F214EF07D7700B26E40E562F267AF7306974 L_50;
		L_50 = Quaternion_op_Multiply_m5AC8B39C55015059BDD09122E04E47D4BFAB2276_inline(L_25, L_49, NULL);
		return L_50;
	}
}
